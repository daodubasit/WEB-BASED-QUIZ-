...
<div class="col-lg-12" style="margin-top:50px;color:#dddddd;font-size:14px;">
	...
	<img style="width:20%;height:20%;position:relative;left:60%" src="<?php echo base_url($_SESSION['filen']);?>" >

   <img style="width:20%;height:20%;position:relative;left:65%" src="<?php echo base_url('images/0001.jpg');?>" > 

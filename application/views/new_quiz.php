 ...
 <div class="login-panel panel panel-default">
		...
		?>	
				...
				<div class="form-group">	 
					...
					<input type="text" name="start_date"  value="<?php echo date('Y-m-d H:i:s',time());?>" class="form-control" placeholder="<?php echo $this->lang->line('start_date');?>"  >
			</div>
				<div class="form-group">	 
				...
				<div class="form-group">	 
					...
					<input type="hidden" name="ip_address"  value="" class="form-control"  >
			</div>
				<div class="form-group">	 
					
					<input type="hidden" name="view_answer"    value="1" checked  >
					<input type="hidden" name="view_answer"    value="0" > 
			</div>
				<div class="form-group">	 
					
					<input type="hidden" name="with_login"    value="0"  > 
					<input type="hidden" name="with_login"    value="1" checked > 
			</div>
			<?php 
			if($this->config->item('webcam')==true){
				...
				<div class="form-group">	 
					...
					<input type="hidden" name="camera_req"    value="1"  > 
					<input type="hidden" name="camera_req"    value="0"  checked > 
			</div>
			<?php 
			}else{
				?>
			...
			?> 
				...
				<div class="form-group">	 
					...
					<input type="hidden" name="question_selection"    value="1"  > 

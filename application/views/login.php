...
<div class="col-md-10">
<a href="<?php echo base_url();?>"><img src="<?php echo base_url('images/unnamed.png');?>"></a>
<?php echo '<b>Test Platform</b>';?>
</div>
<div class="col-md-1">
</div>
...
<div class="container" >   
 <style type="text/css">
 	body{
 		background-image: url("<?php echo base_url('css/images.jpg');?>");
 	}
 </style>

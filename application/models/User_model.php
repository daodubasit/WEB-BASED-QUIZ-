...
Class User_model extends CI_Model
{
 ...
 function user_list($limit){
	 if($this->input->post('search')){
		...
		//print_r($_SESSION['unaame']);
		 $userr=$_SESSION['unaame'];
		 $this -> db -> join('savsoft_group', 'savsoft_users.gid=savsoft_group.gid');
		 if ($userr == 'maitanmi@yahoo.com') {
		 	 $query=$this->db->query("select * from savsoft_users where gid='1' && su!='1' ");
		return $query->result_array();
		 }
		 else if ($userr == 'ogunlere@yahoo.com') {

		 	$query=$this->db->query("select * from savsoft_users where gid='2' && su!='1' ");

		 
		 	return $query->result_array();
		 }
		  else if ($userr == 'akinsanya@yahoo.com') {

		 	$query=$this->db->query("select * from savsoft_users where gid='3' && su!='1' ");
		 	
		 	return $query->result_array();
		 }
		  else if ($userr == 'eze@yahoo.com') {

		 	$query=$this->db->query("select * from savsoft_users where gid='4' && su!='1'");
 ...
 function num_users(){
	 $userr=$_SESSION['unaame'];
		if ($userr == 'maitanmi@yahoo.com') {
			$query=$this->db->query("select * from savsoft_users where gid='1' ");
			$x= $query->num_rows();
		...
		return $x;
		 	...
		 	$query=$this->db->query("select * from savsoft_users where gid='2' ");
			$x= $query->num_rows();
		...
		return $x;
		 	...
		 	$query=$this->db->query("select * from savsoft_users where gid='3' ");
			$x= $query->num_rows();
...
$query=$this->db->query("select * from savsoft_users where gid='4' ");
			$x= $query->num_rows();

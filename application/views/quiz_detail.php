...
<div id="my_photo" style="width:0px;height:0px;background:#000000;padding:2px;border:1px solid #000000;color:red"></div>
<br><br>
...
<div id="my_phkkoto" style="width:519px;position:absolute;top:420px;left:17px;height:513px;background:#ffffff;padding:2px;border:0px solid #000000;color:red"></div>
<button class="btn btn-success" type="button" style="position:absolute;top:415px;" onClick="javascript:capturephoto();"><?php echo $this->lang->line('capture_start_quiz');?></button>
<?php 
}else{
?>	

 ...
 <div class="login-panel panel panel-default">
		...
		?>
				...
				<div class="form-group">	 
					...
					<input type="text"  name="description"  value="<?php echo $quiz['description'];?>" class="form-control" required autofocus>
			</div>

			<div class="form-group">	 
					<label for="inputEmail"  ></label> 
					<input type="hidden" name="start_date"  value="<?php echo date('Y-m-d H:i:s',$quiz['start_date']);?>" class="form-control" placeholder="<?php echo $this->lang->line('start_date');?>"   required >
			</div>

				<div class="form-group">	 
					<label for="inputEmail"  ></label> 
					<input type="hidden" name="end_date"  value="<?php echo date('Y-m-d H:i:s',$quiz['end_date']);?>" class="form-control" placeholder="<?php echo $this->lang->line('end_date');?>"   required >
			</div>
				<div class="form-group">	 
				...
				<div class="form-group">	 
					<input type="hidden" name="view_answer"    value="0" <?php if($quiz['view_answer']==1){ echo 'checked'; } ?>  > 
					<input type="hidden" name="view_answer"    value="1"   <?php if($quiz['view_answer']==0){ echo 'checked'; } ?>  >
			</div>


			<div class="form-group">	 
					<label for="inputEmail" ></label> <br>
					<input type="hidden" name="with_login"    value="0"  <?php if($quiz['with_login']==0){ echo 'checked'; } ?>   >
					<input type="hidden" name="with_login"    value="1" <?php if($quiz['with_login']==1){ echo 'checked'; } ?>  > 
			</div>
			...
			if($this->config->item('webcam')==true){
				...
				<div class="form-group">	 
					 <br>
					<input type="hidden" name="camera_req"    value="1"   <?php if($quiz['camera_req']==1){ echo 'checked'; } ?>  > 
					<input type="hidden" name="camera_req"    value="0"   <?php if($quiz['camera_req']==0){ echo 'checked'; } ?>    > 
			</div>

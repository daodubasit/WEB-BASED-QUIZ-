	...
	?>
        ...
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Test Platform</a>
          </div>
          <div id="navbar" class="navbar-collapse collapse">
			...
			?>
			  ...
			  <li class="dropdown" <?php if($this->uri->segment(1)=='qbank'){ echo "class='active'"; } ?> >
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo 'Question List';?> <span class="caret"></span></a>
                <ul class="dropdown-menu">
